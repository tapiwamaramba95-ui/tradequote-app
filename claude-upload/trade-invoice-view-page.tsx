...
import { DollarSign, Edit, Send, CheckCircle2, Download, Printer, AlertTriangle, ArrowRight } from 'lucide-react'
...
export default function InvoiceDetailPage() {
  ...
  const handleSendEmail = async () => {
    ...
    const confirmed = confirm(`Send invoice to ${invoice.jobs.clients.email}?`)
    if (!confirmed) return
