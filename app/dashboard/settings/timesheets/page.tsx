    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Configure how timesheets work for your business</p>
        </div>
        <Link
      ...
      <div className="space-y-6">
        ...
        <SettingsCard title="General Preferences" description="View settings and default work hours">
          ...
          <div className="mt-4 p-3 rounded-md" style={{
            ...
            <p className="text-sm" style={{ color: colors.text.secondary }}>
              💡 Timezone is configured in <Link href="/dashboard/settings/company" className="underline" style={{ color: colors.accent.DEFAULT }}>Company Settings</Link>
            </p>
          </div>
        </SettingsCard>
        ...
        {/* Time Rounding */}
        <SettingsCard title="Time Rounding" description="Configure how time entries are rounded">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium mb-2" style={{ color: colors.text.primary }}>
                Round to nearest
              ...
              >
                <option value={1}>1 minute (precise)</option>
        ...
        {/* Notifications */}
        <SettingsCard title="Notifications" description="Configure timesheet reminders">
          <div className="space-y-4">
            <div className="flex items-center justify-between py-4">
              <div>
                <p className="font-medium" style={{ color: colors.text.primary }}>
                ...
                <p className="text-sm text-gray-500">
                  Send notifications if not clocked in by start time
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={remindClockIn}
            ...
            <div className="flex items-center justify-between py-4">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Send notifications if still clocked in after hours
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={remindClockOut}
        ...
        {/* Export Settings */}
        <SettingsCard title="Export Settings" description="Configure timesheet export preferences">
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium mb-2" style={{ color: colors.text.primary }}>
            ...
            <div className="flex items-center justify-between py-4">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Add timesheet entry notes to exported reports
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
        ...
        <div className="flex justify-end pt-6">
          <button
            onClick={handleSave}
            disabled={saving}
            className="px-8 py-3 rounded-lg text-sm font-medium text-white disabled:opacity-50 disabled:cursor-not-allowed transition-all"
